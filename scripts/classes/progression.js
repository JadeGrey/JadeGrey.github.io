export default class Progress {
    constructor(clickPower = 1, autoPower = 0, totalPoints = 0, points = 0, multiplier = 1, cur_upgrades = [], dust = 0) {
    ...
    accend() {
        if (Progress.canAccend()) {
            ...
            p = new Progress(1, 0, this.totalPoints, 0, this.multiplier + (this.dust/10), [], 0)
            this = p
        }
    }

    static fromObject(obj) {
        return new Progress(obj.clickPower, obj.autoPower, obj.totalPoints, obj.points, obj.multiplier, obj.upgrades, obj.dust)
    }
}